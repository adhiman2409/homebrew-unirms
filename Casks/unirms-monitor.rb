cask "unirms-monitor" do
  ...
  url "https://github.com/adhiman2409/homebrew-unirms/releases/download/v#{version}/UnirmsMonitor-#{version}.dmg"
  name "UNIRMS Activity Monitor"
  desc "Professional activity monitoring solution for UNIRMS"
  homepage "https://github.com/adhiman2409/homebrew-unirms"
